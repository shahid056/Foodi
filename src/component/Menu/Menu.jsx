      ...
      <div className="w-full flex overflow-hidden flex-wrap justify-between p-10">
        {data != null && data.length >= 0 ? (
          data.map((recipe) => (
            <div
              key={recipe.idMeal}
              className="w-full mb-10 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
            >
              <a href="#">
                <img
              ...
              <div className="px-5 pb-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a
                    onClick={() => handleid(recipe.idMeal)}
                    href="#"
          ...
          <div className="bg-red-900 ml-auto mr-auto">
            <img src={cart} />
          </div>
        )}
      </div>
